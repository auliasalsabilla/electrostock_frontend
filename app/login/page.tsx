...
export default function Login() {
  ...
  const demoCredentials: Record<string, { email: string; password: string }> = {
    admin: { email: "admin@electrostock.com", password: "admin123" },
    staff: { email: "staff@electrostock.com", password: "staff123" },
    manager: { email: "manager@electrostock.com", password: "manager123" },
  };
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-[#0C447C] via-[#378ADD] to-[#0C447C] p-12 flex-col justify-between relative overflow-hidden">
        <div className="relative z-10">
          ...
          <h1 className="text-5xl font-bold text-white mb-6 leading-tight">
            Sistem Manajemen
            <br />
            Inventaris Profesional
          </h1>
          <p className="text-xl text-blue-100 mb-12 max-w-md leading-relaxed">
            Kelola stok komponen elektronik dengan lebih efisien dan terorganisir
          </p>
        ...
        <div className="relative z-10 text-blue-100 text-sm">
          © 2026 ElectroStock. All rights reserved.
        </div>
      </div>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-8">
            <form onSubmit={handleLogin} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full py-3.5 bg-gradient-to-r from-[#378ADD] to-[#0C447C] text-white rounded-xl hover:shadow-xl transition-all transform hover:scale-[1.02] font-semibold"
              >
                Login Sekarang
              </button>
            </form>
          ...
          {/* Demo Credentials */}
          <div className="mt-6 bg-gradient-to-br from-blue-50 to-purple-50 border-2 border-blue-200 rounded-2xl p-6">
            <div className="flex items-center justify-between mb-4">
              <p className="text-[#0C447C] font-semibold text-sm">Demo Login Credentials</p>
              <button
                onClick={fillDemoCredentials}
                className="px-4 py-1.5 bg-[#378ADD] text-white rounded-lg hover:bg-[#0C447C] transition text-xs font-medium"
              >
                Isi Otomatis
              </button>
            </div>
            <div className="space-y-3 text-sm">
              <div className="p-3 bg-white rounded-lg border border-blue-200">
                <p className="text-[#0C447C] font-semibold mb-1">👤 Admin</p>
                <p className="text-gray-600 text-xs">admin@electrostock.com / admin123</p>
              </div>
              <div className="p-3 bg-white rounded-lg border border-green-200">
                <p className="text-[#0C447C] font-semibold mb-1">📦 Staff Gudang</p>
                <p className="text-gray-600 text-xs">staff@electrostock.com / staff123</p>
              </div>
              <div className="p-3 bg-white rounded-lg border border-purple-200">
                <p className="text-[#0C447C] font-semibold mb-1">📊 Manager</p>
                <p className="text-gray-600 text-xs">manager@electrostock.com / manager123</p>
              </div>
            </div>
          </div>
        </div>
