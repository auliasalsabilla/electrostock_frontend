...
import {
  LayoutDashboard, Package, ArrowDownToLine, FileText,
  Bell, Settings as SettingsIcon, LogOut, Menu, X, UserCog, Database,
} from "lucide-react";
  ...
  return (
    <ProtectedRoute>
      <div className="flex h-screen bg-gray-50 overflow-hidden">
        {/* Sidebar */}
        <aside className={`${sidebarOpen ? "w-72" : "w-20"} bg-gradient-to-b from-[#0C447C] to-[#378ADD] text-white transition-all duration-300 flex flex-col shadow-2xl fixed h-screen z-40`}>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex items-center gap-3 pl-4 border-l border-gray-200">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-[#0C447C]">{user?.name || "User"}</p>
